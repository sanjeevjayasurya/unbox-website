const _assetUrl = (m) => (m && typeof m === "object" ? (m.default && m.default.src) || m.default || m.src || m : m);
...
export const  heroVideo = _assetUrl(require("./assets/unbox-robot.mp4"))
export const heroVideoPoster = _assetUrl(require("./assets/unbox-robot-poster.jpg"))
